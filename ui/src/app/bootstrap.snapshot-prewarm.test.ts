...
describe("bootstrap routed snapshot prewarm", () => {
  it.each([
    ...
    { key: "main", boot: true, url: "/focus/terminal", expected: null },
    { key: "agent:main:main", boot: false, url: "/focus/terminal", expected: null },
    { key: "agent:main:main", boot: true, url: "/approve/approval-1", expected: null },
    {
      key: "agent:main:main",
      boot: true,
      url: "/focus/terminal?gatewayUrl=ws%3A%2F%2Fanother.example",
      expected: null,
    },
