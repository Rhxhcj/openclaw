  ...
  for (const { name, paths } of [
    ...
    },
    {
      ...
      paths: [
        ...
        "src/gateway/worker-environments/node-worker-workspace-fallback.ts",
        "src/gateway/worker-environments/node-worker-repository-preparation.ts",
        "src/gateway/worker-environments/node-worker-repository-preparation.test.ts",
